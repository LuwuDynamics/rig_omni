...
// 调试：明文指定 WiFi（设为 0 则使用 NVS 中保存的配置）
#define USE_HARDCODED_WIFI       1
#define HARDCODED_WIFI_SSID      "XGO2"
#define HARDCODED_WIFI_PASSWORD  "LuwuDynamics"

// 定期在串口打印 WiFi IP（秒，设为 0 关闭）
#define PRINT_WIFI_IP_INTERVAL_SEC  2
